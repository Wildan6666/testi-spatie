    ...
    <div className="landing-container">
      ...
      <div className="min-h-screen bg-gradient-to-br from-orange-50 to-pink-50 py-10">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-6 p-6">
          ...
          <div className="lg:col-span-2 bg-white shadow-lg rounded-xl p-6" data-aos="fade-right">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
              ...
              <div><span className="font-medium text-gray-700">Status:</span>
                <p className={`font-semibold ${doc.status === "Berlaku" ? "text-green-600" : "text-red-600"}`}>{doc.status}</p>
              </div>
              ...
              <div><span className="font-medium text-gray-700">Jenis File:</span><p>{doc.type}</p></div>
            </div>
            ...
            <div className="mt-6 flex items-center gap-6 text-sm text-gray-600">
              <div className="flex items-center gap-1">
                ...
                <span>{doc.lihat} kali dilihat</span>
              </div>
              <div className="flex items-center gap-1">
                <Download size={16} className="text-gray-500" />
                <span>{doc.unduh} kali diunduh</span>
              </div>
            </div>
          ...
          {/* Sidebar Pencarian */}
          <aside className="bg-white shadow-lg rounded-xl p-6" data-aos="fade-left">
            <h3 className="text-lg font-semibold text-gray-800 mb-4">Cari Peraturan</h3>
            <div className="space-y-4">
              ...
              <button
                onClick={() => {
                  if (keyword.trim() !== "") {
                    router.visit(`/dokumen?search=${encodeURIComponent(keyword)}`);
                  }
                }}
